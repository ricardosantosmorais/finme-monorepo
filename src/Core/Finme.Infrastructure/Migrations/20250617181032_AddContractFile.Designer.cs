...
namespace Finme.Infrastructure.Migrations
{
    ...
    [Migration("20250617181032_AddContractFile")]
    partial class AddContractFile
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Finme.Domain.Entities.OperationPitch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("OperationPitch", (string)null);
                });
            ...
            modelBuilder.Entity("Finme.Domain.Entities.OperationPitch", b =>
                {
                    b.HasOne("Finme.Domain.Entities.Operation", "Operation")
                        .WithOne("Pitch")
                        .HasForeignKey("Finme.Domain.Entities.OperationPitch", "OperationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

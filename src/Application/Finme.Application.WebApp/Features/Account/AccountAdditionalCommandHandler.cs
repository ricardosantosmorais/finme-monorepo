...
namespace Finme.Application.WebApp.Features.Account.Commands
{
    public class AccountAdditionalCommandHandler(
        ...
        IMapper mapper) : IRequestHandler<AccountAdditionalCommand, UserResponseDto>
    {
        private readonly IRepository<User> _userRepository = userRepository;
        private readonly IRepository<UserAddress> _userAddressRepository = userAddressRepository;
        private readonly IMapper _mapper = mapper;

        public async Task<UserResponseDto> Handle(AccountAdditionalCommand request, CancellationToken cancellationToken)
        {

...
namespace Finme.Application.WebApp.Features.Account.Commands
{
    public class AccountPersonaCommandHandler(
        ...
        IMapper mapper) : IRequestHandler<AccountPersonaCommand, UserResponseDto>
    {
        private readonly IRepository<User> _userRepository = userRepository;
        private readonly IMapper _mapper = mapper;

        public async Task<UserResponseDto> Handle(AccountPersonaCommand request, CancellationToken cancellationToken)
        {

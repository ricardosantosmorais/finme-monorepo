...
namespace Finme.Application.WebApp.Features.Account.Commands
{
    public class AccountPhotoCommandHandler(
        ...
        IMapper mapper) : IRequestHandler<AccountPhotoCommand, UserResponseDto>
    {
        ...
        public async Task<UserResponseDto> Handle(AccountPhotoCommand request, CancellationToken cancellationToken)
        {

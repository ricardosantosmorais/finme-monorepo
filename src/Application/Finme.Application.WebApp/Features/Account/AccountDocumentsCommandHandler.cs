...
namespace Finme.Application.WebApp.Features.Account.Commands
{
    public class AccountDocumentsCommandHandler(
        ...
        IMapper mapper) : IRequestHandler<AccountDocumentsCommand, UserResponseDto>
    {
        ...
        public async Task<UserResponseDto> Handle(AccountDocumentsCommand request, CancellationToken cancellationToken)
        {

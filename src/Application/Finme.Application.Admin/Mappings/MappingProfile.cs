...
namespace Finme.Application.Admin.Mappings
{
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            ...
            CreateMap<Administrator, ForgotResponseDto>()
            ...
            CreateMap<Operation, OperationDto>()
                ...
                .ForMember(dest => dest.ContractFile, opt => opt.MapFrom(src => src.ContractFile))
            ...
            CreateMap<SaveAdministratorCommand, Administrator>()
                .ForMember(dest => dest.FullName, opt => opt.MapFrom(src => src.FullName))
                .ForMember(dest => dest.Telephone, opt => opt.MapFrom(src => src.Telephone))
                .ForMember(dest => dest.Cpf, opt => opt.MapFrom(src => src.Cpf))
                .ForMember(dest => dest.Email, opt => opt.MapFrom(src => src.Email))
            ...
            CreateMap<InvestmentStatusDto, InvestmentStatus>();
        }
    }
}

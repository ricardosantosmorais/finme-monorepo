...
using Finme.Api.WebApp.Middleware;
using Finme.Application.WebApp.Behaviors;
    ...
    public class Program
    {
        ...
        private static void ConfigureValidators(WebApplicationBuilder builder)
        {
            builder.Services.AddValidatorsFromAssembly(
                typeof(Finme.Application.WebApp.Validators.RegisterCommandValidator).Assembly);
        }

        private static void ConfigureAutoMapper(WebApplicationBuilder builder)
        {
            builder.Services.AddAutoMapper(
                typeof(Finme.Application.WebApp.Mappings.MappingProfile).Assembly);
        }
